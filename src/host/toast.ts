...
function writeWinScript(script: string): { dir: string; file: string } {
...
function winToast(title: string, body: string): void {
  try {
 ...
 */
export function fireNativeToast(payload: NativeToastPayload): boolean {
